                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('city') ? ' has-error' : '' }}">
                            <label for="city" class="col-md-4 control-label">Kab/Kota</label>
                        ...
                        <div class="form-group{{ $errors->has('districts') ? ' has-error' : '' }}">
                            <label for="districts" class="col-md-4 control-label">Kelurahan</label>

                            <div class="col-md-6">
                                <select class="form-control" name="districts" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('address') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea class="form-control" name="address" rows="2" cols="80" required autofocus></textarea>
